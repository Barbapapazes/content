...
describe('module', () => {
  it('[sources] [array] Relative path', () => {
  ...
  it('[sources] [array] Absolute path', () => {
    const mounts = useContentMounts(nuxtDummy, ['/content'])
  ...
  it('[sources] [array] Custom driver', () => {
  ...
  it('[sources] [array] Multiple storages', () => {
    const mounts = useContentMounts(nuxtDummy, [
      'content',
      '/repo1/docs',
      'repo2/docs',
  ...
  it('[sources] [array] overwrite default source', () => {
    const mounts = useContentMounts(nuxtDummy, [
      {
        name: 'content',
        driver: 'http',
  ...
  it('[sources] [object] overwrite default source', () => {
    const mounts = useContentMounts(nuxtDummy, {
      content: {
        driver: 'http',
        base: 'https://cdn.com',
  ...
  it('[sources] [object] secondary source', () => {
    const mounts = useContentMounts(nuxtDummy, {
      secondary: {
        driver: 'http',
        base: 'https://cdn.com',
